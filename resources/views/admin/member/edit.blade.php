...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form class="row g-3 needs-validation" action="{{ route('member.update', $member->id) }}" method="POST"
                            ...
                            <div class="row align-items-center g-3 mt-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_member"
                                        ...
                                        value="{{ old('nama_member', $member->nama_member) }}" id="nama_member"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="no_hp"
                                        ...
                                        value="{{ old('no_hp', $member->no_hp) }}" id="no_hp" placeholder="Phone">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="L" name="gender"
                                            ...
                                            {{ old('gender', $member->gender) == 'L' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="P" name="gender"
                                            ...
                                            {{ old('gender', $member->gender) == 'P' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="alamat"
                                        ...
                                        value="{{ old('alamat', $member->alamat) }}" id="alamat" placeholder="Address">
